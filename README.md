...
Apesar de ainda não ter total domínio do Redux, consegui desenvolver um site que consome os dados da [API de Cotações de Moedas](https://docs.awesomeapi.com.br/api-de-moedas) e amazena no estado global da aplicação o retorno da API e as informações preenchidas no formulário pelo usuário. Também desenvolvi testes utilizando React Testing Library.
...
```
git clone git@github.com:lucas-da-silva/project-trybewallet.git
```
